...
let CartItemTest =  require('../src/CartItem/CartItem.js');
...
test('allGetters_NominalCase_Success', () => {
    ...
    let quantity = 10;
    let price = 20;
    let cartItem = new CartItemTest(articleId, name, quantity, price);
    let total = 200;
...
test('constructor_InvalidArticleId_ThrowException', () => {
    ...
    //when
    expect(() => new CartItemTest(articleId, name, quantity, price)).toThrow(InvalidArticleIdException);
...
test('constructor_InvalidQuantity_ThrowException', () => {
    ...
    //when
    expect(() => new CartItemTest(articleId, name, quantity, price)).toThrow(InvalidQuantityException);
...
test('constructor_InvalidPrice_ThrowException', () => {
    ...
    //when
    expect(() => new CartItemTest(articleId, name, quantity, price)).toThrow(InvalidPriceException);
